		...
		<div class="clearfix container">
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						<security:authorize access="hasRole('ROLE_ADMIN')"> <!-- utilizamos a taglib de security para apresentar os links somente para usuarios autenticados -->
						...
						<li><a href="?locale=pt" rel="nofollow"><img src="${contextPath}resources/imagens/brazil.png"></a></li> <!-- permito ao usuario escolher o idioma da aplicacao -->
						<li><a href="?locale=en_US" rel="nofollow"><img src="${contextPath}resources/imagens/united-states.png"></a></li> <!-- allows user to choose the app language -->
					</ul>
				</nav>
			</div>
		</div>
