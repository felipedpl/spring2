...
<tags:pageTemplate titulo="${produto.titulo}">
	...
	<!--  <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }" /> o Spring Security espera uma protecao nos POST dos formularios para evitar ataques. Para 
			nao precisar colocar este campo em todos os forms, basta usar a tag de form do Spring que ja embuti essa segurança form:form
	 --> 
	  
	  <section class="buy-options clearfix">  
	  <form:form servletRelativeAction="/carrinho/add" method="post" class="container"> <!--  usaremos c:url para criar urls baseadas no contexto /casadocodigo para criar urls completas -->
