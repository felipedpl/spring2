...
<jsp:attribute name="extraScripts"> <!-- estou utlizando fragmento para rodar scripts, preciso colocar essa tag na pagina e em seguida a tag de body, ambas do JSP -->
